module QueryableProviderImplementation
...
type BasicGenerativeProvider (config : TypeProviderConfig) as this =
    inherit TypeProviderForNamespaces (config, assemblyReplacementMap=[("QueryableProvider.DesignTime", "QueryableProvider.Runtime")])
